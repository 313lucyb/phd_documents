...
jointFit <- readRDS("~/jointmodelresults/haq3.rds")

file.names<-c("cal30.csv","cal31.csv","cal32.csv","cal33.csv", "cal34.csv", "cal35.csv", "cal36.csv")
...
stopCluster(cl)
print(JMTA)
write.table(JMTA, file = "./JM3_TA.csv", sep = ",", col.names = NA,
            qmethod = "double")

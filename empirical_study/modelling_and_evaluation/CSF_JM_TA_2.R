...
jointFit <- readRDS("~/jointmodelresults/haq2.rds")

file.names<-c("cal20.csv","cal21.csv","cal22.csv","cal23.csv", "cal24.csv", "cal25.csv", "cal26.csv")
...
stopCluster(cl)
print(JMTA)
write.table(JMTA, file = "./JM2_TA.csv", sep = ",", col.names = NA,
            qmethod = "double")

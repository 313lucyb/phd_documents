...
write.table(performance_results, file = paste("./performance_results_jm_d2_s1_p2_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
write.table(stability_results, file = paste("./stability_results_jm_d2_s1_p2_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")

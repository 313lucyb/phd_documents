...
write.table(performance_results, file = paste("./performance_results_tdcm_d2_s2_p2_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
write.table(stability_results, file = paste("./stability_results_tdcm_d2_s2_p2_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")

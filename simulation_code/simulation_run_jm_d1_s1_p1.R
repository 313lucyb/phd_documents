...
sims_parameters <- crossing(
  ...
  j = 8,
  weibull_shape = 1,
  weibull_scale = c(exp(-13.331), exp(-11.14453)),
  probability_missing = 0.2,
  prediction_window = 1,
...
write.table(performance_results, file = paste("./performance_results_jm_d1_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
write.table(stability_results, file = paste("./stability_results_jm_d1_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")

...
sims_parameters <- crossing(
  ...
  j = 8,
  weibull_shape = 0.75,
  weibull_scale = c(exp(-6.283), exp(-4.652)),
...
write.table(performance_results, file = paste("./performance_results_jm_d2_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
write.table(stability_results, file = paste("./stability_results_jm_d2_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")

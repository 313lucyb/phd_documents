...
sims_parameters <- crossing(
  ...
  j = 8,
  weibull_shape = 0.9,
  weibull_scale = c(0.00257, 0.01265),
...
write.table(performance_results, file = paste("./performance_results_tdcm_d2_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
write.table(stability_results, file = paste("./stability_results_tdcm_d2_s1_p1_",s, ".csv", sep=""), sep = ",", col.names = NA,
            qmethod = "double")
